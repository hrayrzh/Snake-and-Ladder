...
//	},
	101: {
		head: "կանոններ",
		content: "ԷկոՇուտՀասիկ խաղերն օգնում են երիտասարդներին իմանալ բնապահպանական խնդիների մասին ևձեռնարկել քայլեր՝ պահպանելու Երկիր մոլորակը։ Խաղերը մշակված են տարբեր թեմաների շուրջ, ոչ-ֆորմալ կրթական մեխանիզմների հիման վրա, որոնք մատչելի և ինտերակտիվ ձևով ներկայացնում ենգիտական տեղեկատվությունը բոլորի համար։Խաղի համար անհրաժեշտ են՝ Զառ Խաղաքարեր (որպես խաղաքար կարող եք վերցնելտարբեր գույնի կամ չափսերի փոքր քարեր) Խաղին մասնակցում են 2-6 խաղացող, 3 տարեկանից բարձր։Խաղի կանոնները՝1. Մասնակիցներն ընտրում են իրենց խաղաքարերը և տեղադրում վանդակ 1-ում։2. Խաղը սկսում է ամենափոքր խաղացողը. նետում է զառը և խաղաքարը վանդակներով առաջ տանում։3. Յուրաքանչյուր վանդակում կանգ առնելիս խաղացողը բարձրաձայն կարդում է թափոններին վերաբերյալփաստը և ուղերձը։4. Թղթե օդանավերով վանդակին հասնելիս, կախված նշված ուղությունից, խաղացողը բարձրանում կամ իջնում էդեպի նշված վանդակը։5. Վերջին վանդակին հասնելու համար հաղթողի նետած զառի թիվը պետք է ճիշտ այն թիվը լինի, որնանհրաժեշտ է այդ վանդակին հասնելու համար։ Եթե զառի վրայի թիվն ավելին է, քան անհրաժեշտ է վերջինվանդակին հասնելու համար, պետք է խաղաքարով առաջ շարժվել մինչև վերջին վանդակը և հետո մնացած թվիչափով հետ շարժվել վանդակով։",
		color: "black",
